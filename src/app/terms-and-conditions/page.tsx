    ...
    <>
      ...
      <Section className="bg-white border-b-black border-b-2">
        <div className="prose max-w-none text-gray-800 pb-12 policy">
          ...
          <Title tag="h2">Use of Our Services</Title>
          ...
          <Title tag="h2">Accounts and Security</Title>
          <p>
          ...
          <Title tag="h2">Payments and Refunds</Title>
          <p>
          ...
          <Title tag="h2">Intellectual Property</Title>
          <p>
          ...
          <Title tag="h2">Limitation of Liability</Title>
          <p>
          ...
          <Title tag="h2">Changes to These Terms</Title>
          <p>
          ...
          <Title tag="h2">Governing Law</Title>
          <p>
